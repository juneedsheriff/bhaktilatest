...
<body class="bg-light">
  ...
  <div class="container bg-white p-4 shadow rounded mb-4">
    ...
    <div class="overflow-hidden position-relative  banner-over-container">
        ...
        <img class="w-100 banner-h-420" src="app/uploads/iconic_temple/banner/<?php echo $Row->banner; ?>" style="" alt="Temple Image">
          ...
          <div class="row">
            <?php 
              ...
              foreach ($existingImages as $image) {
                  ...
                  $imagePath = "app/uploads/iconic_temple/gallery/" . htmlspecialchars($image);

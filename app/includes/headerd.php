                    ...
                    <ul class="metismenu">
                        ...
                        <li class="<?php echo in_array($current_page, ['add-temple.php','temple-listing.php','temple-upload.php']) ? 'mm-active' : ''; ?>">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo ($current_page === 'add-temple.php') ? 'mm-active' : ''; ?>"><a href="add-temple.php">Add New Temple</a></li>



                                <li class="<?php echo ($current_page === 'temple-listing.php') ? 'mm-active' : ''; ?>"><a href="temple-listing.php">Temples Listing</a></li>



                                <li class="<?php echo ($current_page === 'temple-upload.php') ? 'mm-active' : ''; ?>"><a href="temple-upload.php">Bulk Upload</a></li>
                        ...
                        <li class="<?php echo in_array($current_page, ['add-abroad-temple.php','temple-abroad-listing.php','abroad-upload.php']) ? 'mm-active' : ''; ?>">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo ($current_page === 'add-abroad-temple.php') ? 'mm-active' : ''; ?>"><a href="add-abroad-temple.php">Add New Temple</a></li>



                                <li class="<?php echo ($current_page === 'temple-abroad-listing.php') ? 'mm-active' : ''; ?>"><a href="temple-abroad-listing.php"> Temples Listing</a></li>



                                <li class="<?php echo ($current_page === 'abroad-upload.php') ? 'mm-active' : ''; ?>"><a href="abroad-upload.php">Bulk Upload</a></li>
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo in_array($current_page, ['add-iconic-category.php','temple-iconic-category-listing.php','iconic-category-upload.php']) ? 'mm-active' : ''; ?>">
                                    ...
                                    <ul class="nav-third-level">
                                        ...
                                        <li class="<?php echo ($current_page === 'add-iconic-category.php') ? 'mm-active' : ''; ?>"><a href="add-iconic-category.php">Add Iconic Homepage</a></li>



                                        <li class="<?php echo ($current_page === 'temple-iconic-category-listing.php') ? 'mm-active' : ''; ?>"><a href="temple-iconic-category-listing.php">Iconic Homepage Listing</a></li>



                                        <li class="<?php echo ($current_page === 'iconic-category-upload.php') ? 'mm-active' : ''; ?>"><a href="iconic-category-upload.php">Bulk Upload</a></li>
                                ...
                                <li class="<?php echo ($current_page === 'iconic_temple_add.php') ? 'mm-active' : ''; ?>"><a href="iconic_temple_add.php">Add Iconic Temple</a></li>



                                <li class="<?php echo ($current_page === 'iconic_temple_list.php') ? 'mm-active' : ''; ?>"><a href="iconic_temple_list.php"> Iconic Temples Listing</a></li>



                                <li class="<?php echo ($current_page === 'iconic-temple-upload.php') ? 'mm-active' : ''; ?>"><a href="iconic-temple-upload.php">Temples Bulk Upload</a></li>
                        ...
                        <li class="<?php echo ($current_page === 'temple-mystery-listing.php') ? 'mm-active' : ''; ?>">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo ($current_page === 'temple-mystery-listing.php') ? 'mm-active' : ''; ?>"><a href="temple-mystery-listing.php"> Mystery Temples Listing</a></li>
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo in_array($current_page, ['mantras_category_add.php','mantras_category.php']) ? 'mm-active' : ''; ?>">
                                    ...
                                    <ul class="nav-third-level">
                                        ...
                                        <li class="<?php echo ($current_page === 'mantras_category_add.php') ? 'mm-active' : ''; ?>"><a href="mantras_category_add.php"> Mantras Category Add </a></li>



                                        <li class="<?php echo ($current_page === 'mantras_category.php') ? 'mm-active' : ''; ?>"><a href="mantras_category.php"> Mantras Category List</a></li>
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo in_array($current_page, ['add_mantras_subcategory.php','mantras_subcategory.php']) ? 'mm-active' : ''; ?>">
                                    ...
                                    <ul class="nav-third-level">
                                        ...
                                        <li class="<?php echo ($current_page === 'add_mantras_subcategory.php') ? 'mm-active' : ''; ?>"><a href="add_mantras_subcategory.php"> Mantras Sub Category Add </a></li>



                                        <li class="<?php echo ($current_page === 'mantras_subcategory.php') ? 'mm-active' : ''; ?>"><a href="mantras_subcategory.php"> Mantras Sub Category List </a></li>
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo in_array($current_page, ['mantras_title_add.php','mantras_title.php']) ? 'mm-active' : ''; ?>">
                                    ...
                                    <ul class="nav-third-level">
                                        ...
                                        <li class="<?php echo ($current_page === 'mantras_title_add.php') ? 'mm-active' : ''; ?>"><a href="mantras_title_add.php"> Mantras Group Add</a></li>



                                        <li class="<?php echo ($current_page === 'mantras_title.php') ? 'mm-active' : ''; ?>"><a href="mantras_title.php"> Mantras Group List</a></li>
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo in_array($current_page, ['mantras_add.php','mantras_list.php','mantras-upload.php']) ? 'mm-active' : ''; ?>">
                                    ...
                                    <ul class="nav-third-level">
                                        ...
                                        <li class="<?php echo ($current_page === 'mantras_add.php') ? 'mm-active' : ''; ?>"><a href="mantras_add.php"> Mantras Add</a></li>



                                        <li class="<?php echo ($current_page === 'mantras_list.php') ? 'mm-active' : ''; ?>"><a href="mantras_list.php"> Mantras List</a></li>



                                        <li class="<?php echo ($current_page === 'mantras-upload.php') ? 'mm-active' : ''; ?>"><a href="mantras-upload.php"> Bulk Upload</a></li>
                        ...
                        <li class="<?php echo in_array($current_page, ['private-ads.php','add-new-private-ad.php']) ? 'mm-active' : ''; ?>">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo ($current_page === 'private-ads.php') ? 'mm-active' : ''; ?>"><a href="private-ads.php"> Private Ads List</a></li>

                                <li class="<?php echo ($current_page === 'add-new-private-ad.php') ? 'mm-active' : ''; ?>"><a href="add-new-private-ad.php"> Add New Private Ads</a></li>
                        ...
                        ?>
                                ...
                                <li class="<?php echo $is_other_active ? 'mm-active' : ''; ?>">
                                    ...
                                    <ul class="nav-second-level">
                                        ...
                                        <li class="<?php echo ($current_page === 'others_page_add.php' && isset($_GET['page_id']) && (string)$_GET['page_id'] === (string)$Row->index_id) ? 'mm-active' : ''; ?>"><a href="others_page_add.php?page_id=<?php echo htmlspecialchars($Row->index_id); ?>"><?php echo htmlspecialchars($Row->name); ?> Add</a></li>



                                        <li class="<?php echo ($current_page === 'other_page.php' && isset($_GET['page_id']) && (string)$_GET['page_id'] === (string)$Row->index_id) ? 'mm-active' : ''; ?>"><a href="other_page.php?page_id=<?php echo htmlspecialchars($Row->index_id); ?>"><?php echo htmlspecialchars($Row->name); ?> List</a></li>
                        ...
                        <?php if ($user_role === 'Admin'): ?>
                            ...
                            <li class="<?php echo in_array($current_page, ['category_add.php','category.php']) ? 'mm-active' : ''; ?>">
                                ...
                                <ul class="nav-second-level">
                                    ...
                                    <li class="<?php echo ($current_page === 'category_add.php') ? 'mm-active' : ''; ?>"><a href="category_add.php">Add New</a></li>



                                    <li class="<?php echo ($current_page === 'category.php') ? 'mm-active' : ''; ?>"><a href="category.php">Page List</a></li>
                        ...
                        <?php if ($user_role === 'Admin'): ?>
                            ...
                            <li class="<?php echo ($current_page === 'stafflist.php') ? 'mm-active' : ''; ?>">
                                ...
                                <ul class="nav-second-level">
                                    ...
                                    <li class="<?php echo ($current_page === 'stafflist.php') ? 'mm-active' : ''; ?>"><a href="stafflist.php"> Staffs List</a></li>
                        ...
                        <li class="<?php echo in_array($current_page, ['gallery_add.php','gallery_list.php']) ? 'mm-active' : ''; ?>">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo ($current_page === 'gallery_add.php') ? 'mm-active' : ''; ?>"><a href="gallery_add.php">Add Gallery</a></li>



                                <li class="<?php echo ($current_page === 'gallery_list.php') ? 'mm-active' : ''; ?>"><a href="gallery_list.php">Galleries Listing</a></li>
                        ...
                        <li class="<?php echo in_array($current_page, ['country_add.php','country.php']) ? 'mm-active' : ''; ?>">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo ($current_page === 'country_add.php') ? 'mm-active' : ''; ?>"><a href="country_add.php">Add New Country </a></li>



                                <li class="<?php echo ($current_page === 'country.php') ? 'mm-active' : ''; ?>"><a href="country.php">Countries Listing</a></li>
                        ...
                        <li class="<?php echo in_array($current_page, ['state_add.php','state.php']) ? 'mm-active' : ''; ?>">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo ($current_page === 'state_add.php') ? 'mm-active' : ''; ?>"><a href="state_add.php">Add New State</a></li>



                                <li class="<?php echo ($current_page === 'state.php') ? 'mm-active' : ''; ?>"><a href="state.php">States Listing</a></li>
                        ...
                        <li class="<?php echo in_array($current_page, ['city_add.php','city.php']) ? 'mm-active' : ''; ?>">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo ($current_page === 'city_add.php') ? 'mm-active' : ''; ?>"><a href="city_add.php">Add New City</a></li>



                                <li class="<?php echo ($current_page === 'city.php') ? 'mm-active' : ''; ?>"><a href="city.php">Cities Listing</a></li>
                        ...
                        <li class="<?php echo in_array($current_page, ['god_add.php','god.php']) ? 'mm-active' : ''; ?>">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo ($current_page === 'god_add.php') ? 'mm-active' : ''; ?>"><a href="god_add.php">Add New God</a></li>



                                <li class="<?php echo ($current_page === 'god.php') ? 'mm-active' : ''; ?>"><a href="god.php">Gods Listing</a></li>
                        ...
                        <li class="<?php echo ($current_page === 'subscribe_list.php') ? 'mm-active' : ''; ?>">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="<?php echo ($current_page === 'subscribe_list.php') ? 'mm-active' : ''; ?>"><a href="subscribe_list.php">Subscribers List</a></li>

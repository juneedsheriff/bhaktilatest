...
if (isset($_POST['delete_now']) && !empty($_POST['del_c'])) {
    ...
    $query = "DELETE FROM `mantras_title` WHERE `index_id` = ?";
    ...
    if ($stmt->execute()) {
        echo "<script>
                ...
                window.location.href = 'mantras_title.php';
              </script>";
    } else {
...
<div class="card-header position-relative">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h6 class="fs-17 fw-semi-bold my-1">Mantras  Group List</h6>
            <!-- <p class="mb-0">Countrys Listing.</p> -->

        </div>
     
        <div class="text-end">
            <a href="mantras_title_add.php" class="btn btn-primary fw-medium"><i class="fa-solid fa-plus me-1"></i>Add New Mantras Group</a>
        </div>
    </div>
</div>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="w-50">Mantras Group Name</th>
                    ...
                    <tbody>
                        <?php $select = "SELECT * FROM `mantras_title` WHERE index_id !='0' ORDER BY index_id  DESC";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm p-2 btn-primary text-white  edit-board alert-box-trigger waves-effect waves-light kill-drop" href="mantras_title_add.php?index_id=<?php echo $Row->index_id; ?>"><i class="fas fa-pencil-alt"></i></a> &nbsp; &nbsp;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="header-title">Delete Mantras Group </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body text-center">
                    <h5 class="text-center">Delete Mantras Group  Details?</h5>
                    <p>Are you sure you want to delete this Mantras Group ? All related data will be lost.</p>
                </div>

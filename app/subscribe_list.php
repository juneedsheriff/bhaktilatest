...
if (isset($_POST['delete_now']) && !empty($_POST['del_c'])) {
    ...
    $query = "DELETE FROM `subscribe` WHERE `index_id` = ?";
    ...
    if ($stmt->execute()) {
        echo "<script>
                ...
                window.location.href = 'subscribe_list.php';
              </script>";
    } else {
...
<div class="card-header position-relative">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h6 class="fs-17 fw-semi-bold my-1">Subscribers</h6>
        ...
        <div class="card">
            <div class="card-body">
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php $select = "SELECT * FROM `subscribe` WHERE index_id !='0' ORDER BY index_id  DESC";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="header-title">Delete Subscribers</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body text-center">
                    <h5 class="text-center">Delete Subscribers Details?</h5>
                    <p>Are you sure you want to delete this Subscribers? All related data will be lost.</p>
                </div>

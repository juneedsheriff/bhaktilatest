...
<div class="card-header position-relative">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h6 class="fs-17 fw-semi-bold my-1">galleries</h6>
            <!-- <p class="mb-0">Countrys Listing.</p> -->

        </div>
     
        <div class="text-end">
            <a href="gallery_add.php" class="btn btn-primary fw-medium"><i class="fa-solid fa-plus me-1"></i>Add New gallery</a>
        </div>
    </div>
</div>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="w-25">gallery Image</th>
                            <th class="w-20">gallery Title</th>
                            <th class="w-5">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $select = "SELECT * FROM `gallery` WHERE index_id !='0' ORDER BY index_id  DESC";
                        $SQL_galleryMENT = mysqli_query($DatabaseCo->dbLink, $select);
                        $num_rows = mysqli_num_rows($SQL_galleryMENT);
                        if ($num_rows != 0) {
                            $i = 1;
                            while ($Row = mysqli_fetch_object($SQL_galleryMENT)) {
                        ?>
                                <tr>
                                    <td><?php echo $i;
                                        $i++; ?></td>
...
?>
    <div class="image-container" id="image-<?= htmlspecialchars($image); ?>" style="display: inline-block; position: relative; margin: 5px;">
        <img src="<?= $imagePath; ?>" alt="Existing Image" class="existing-image" style="width: 25px; height: 25px;">
...
?></td>
                                    ...
                                    <td>
                                        <a class="btn btn-sm p-2 btn-primary text-white  edit-board alert-box-trigger waves-effect waves-light kill-drop" href="gallery_add.php?index_id=<?php echo $Row->index_id; ?>"><i class="fas fa-pencil-alt"></i></a> &nbsp; &nbsp;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="header-title">Delete gallery</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body text-center">
                    <h5 class="text-center">Delete gallery Details?</h5>
                    <p>Are you sure you want to delete this gallery? All related data will be lost.</p>
                </div>

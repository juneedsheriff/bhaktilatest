...
<div class="card-header position-relative">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h6 class="fs-17 fw-semi-bold my-1">States</h6>
   ...
   if (mysqli_num_rows($SQL_STATEMENT) != 0) {
       ...
       <?php }
        ...
        <div class="text-end">
            <a href="state_add.php" class="btn btn-primary fw-medium"><i class="fa-solid fa-plus me-1"></i>Add New State</a>
        </div>
    </div>
</div>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="w-25">State Name</th>
                            <th class="w-20">Status</th>
                            <th class="w-5">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $select = "SELECT * FROM `state` WHERE state_id !='0' AND country_code='$country' ORDER BY state_id  DESC";
                        $SQL_STATEMENT = mysqli_query($DatabaseCo->dbLink, $select);
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm p-2 btn-primary text-white  edit-board alert-box-trigger waves-effect waves-light kill-drop" href="state_add.php?state_id=<?php echo $Row->state_id; ?>"><i class="fas fa-pencil-alt"></i></a> &nbsp; &nbsp;
                                        <a class="btn btn-sm p-2 btn-danger delete-board waves-effect waves-light text-white"
                                            data-toggle="modal"
                                            data-target="#delete-board-alert"
                                            data-id="<?php echo $Row->state_id; ?>"
                                            id="delete-board<?php echo $Row->state_id; ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p>Are you sure you want to delete this State? All related data will be lost.</p>
                </div>

...
if (isset($_POST['delete_now']) && !empty($_POST['del_c'])) {
    ...
    $query = "DELETE FROM `god` WHERE `index_id` = ?";
...
<div class="card-header position-relative">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h6 class="fs-17 fw-semi-bold my-1">Gods</h6>
            <!-- <p class="mb-0">Countrys Listing.</p> -->

        </div>
     
        <div class="text-end">
            <a href="god_add.php" class="btn btn-primary fw-medium"><i class="fa-solid fa-plus me-1"></i>Add New God</a>
        </div>
    </div>
</div>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="w-20">God SubName</th>
                            <th class="w-5">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $select = "SELECT * FROM `god` WHERE index_id !='0' ORDER BY index_id  DESC";
                        $SQL_GodMENT = mysqli_query($DatabaseCo->dbLink, $select);
                        $num_rows = mysqli_num_rows($SQL_GodMENT);
                        if ($num_rows != 0) {
                            $i = 1;
                            while ($Row = mysqli_fetch_object($SQL_GodMENT)) {
                        ?>
                                <tr>
                                    <td><?php echo $Row->index_id;$i++; ?></td>
                                    <td><?php echo $Row->god_name; ?></td>
                                    <td><?php echo $Row->sub_name; ?></td>
                                   

                                    <td>
                                        <a class="btn btn-sm p-2 btn-primary text-white  edit-board alert-box-trigger waves-effect waves-light kill-drop" href="god_add.php?index_id=<?php echo $Row->index_id; ?>"><i class="fas fa-pencil-alt"></i></a> &nbsp; &nbsp;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p>Are you sure you want to delete this God? All related data will be lost.</p>
                </div>

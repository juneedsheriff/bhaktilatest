...
if ($_REQUEST['index_id'] > 0) {
    $titl = "Update ";
    $select = "SELECT * FROM category WHERE index_id ='" . $_REQUEST['index_id'] . "'"; //echo $select;
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">Please fill the required category details.</p>
        ...
        <div class="row is-multiline">
            <div class="mb-4">
                <div class="card-header position-relative">
                    <h6 class="fs-17 fw-semi-bold mb-0">Category Page </h6>
                </div>
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="country_name"><b>Category Name</b></label>
                                <input type="text" name="name" class="form-control" id="name"
                                    placeholder="Enter Category Name" value="<?php echo $Row->name; ?>" required>
                            </div>
                        </div>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (res.success) {
                    ...
                    setTimeout(() => {
                        window.location.href = 'category.php'; // Change to your target page
                    }, 2000);
                } else {

...
<div class="card-header position-relative">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        ...
        <div>
            ...
            <h6 class="fs-17 fw-semi-bold my-1"> Private Ads </h6>
        ...
        <div class="text-end">
            ...
            <a href="add-new-private-ad.php" class="btn btn-primary fw-medium"><i class="fa-solid fa-plus me-1"></i>Add Adv</a>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="w-5">Private?</th>
                            <th class="w-5">Impr.</th>
                            <th class="w-5">Views</th>
                            <th class="w-5">Clicks</th>
                            <th class="w-5">Expires On</th>
                    ...
                    <tbody>
                        <?php
                        $select = "SELECT * FROM `private_ads` ORDER BY id DESC";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($Row->image_path)) { ?>
                                            <a href="<?= $Row->image_path; ?>" target="_blank">
                                                <img src="<?= $Row->image_path; ?>" class="header-profile-user" width="60" alt="">
                                            </a>
                                        <?php } ?>
                                    </td>
                                    ...
                                    <td>
                                        <?= $Row->is_private ? '<span class="badge badge-warning">Yes</span>' : '<span class="badge badge-success">No</span>'; ?>
                                    </td>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="edit-private-ad.php?id=<?= $Row->id; ?>">

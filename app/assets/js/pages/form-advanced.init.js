!(function (i) {
  ...
  (e.prototype.init = function () {
    i(".colorpicker-default").spectrum(),
      i("#show-input").spectrum({ preferredFormat: "hex", showInput: !0 }),
      ...
      i("#show-palette").spectrum({
        showPalette: !0,
        palette: [
          [" #003aa2", "#3ddc97", "#00a7e1"],
          ["rgb(0, 57, 163)", "#f06543", "#343a40"],
        ],
      }),
      ...
      i("#hide-button").spectrum({ showButtons: !1 }),
      i("#flat-colorpicker").spectrum({
        preferredFormat: "hex",
        flat: !0,
        showInput: !0,
      }),
      i(".selectize").selectize(),
      i("#selectize-tags").selectize({
        delimiter: ",",
        persist: !1,
        create: function (e) {

...
if ($("#column_chart_datalabel").length) {
  options = {
    ...
    dataLabels: {
      ...
      offsetY: -20,
      style: { fontSize: "12px", colors: ["#00a7e1"] },
    },
    series: [
      {
        name: "Inflation",
...
if ($("#radial_chart").length) {
  options = {
    ...
    colors: [" #003aa2", "#00a7e1", "#f1b44c", "#3ddc97"],
  };
  (chart = new ApexCharts(
...
if ($("#pie_chart").length) {
  options = {
    ...
    colors: [" #003aa2", "#3ddc97", "rgb(0, 57, 163)", "#f06543", "#eff2f7"],
    legend: {
      show: !0,
      position: "bottom",
...
if ($("#donut_chart").length) {
  ...
  options = {
    ...
    series: [44, 55, 41, 17, 15],
    labels: ["Series 1", "Series 2", "Series 3", "Series 4", "Series 5"],
    colors: [" #003aa2", "#00a7e1", "#3ddc97", "#f06543", "#eff2f7"],
    legend: {
      show: !0,
      position: "bottom",
      horizontalAlign: "center",
